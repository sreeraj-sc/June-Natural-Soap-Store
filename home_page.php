    ...
    <div class="navigation">
      <div class="container">
        <nav class="nav">
          ...
          <div class="nav__menu">
            <div class="menu__top">
              <span class="nav__category">Soap</span>
            ...
            <li class="glide__slide">
              <div class="hero__center">
                <div class="hero__left">
                  <!-- <span class=""></span> -->
                  <h1 class="">June Natural Soap Store</h1>
                  <p>Happiness is handmade soap</p>
                  <a href="#header"><button class="hero__btn">SHOP NOW</button></a>
                </div>
